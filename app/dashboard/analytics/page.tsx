      ...
      <div className="mi-page">
        <div className="mi-topbar">
          <div className="mi-topbar-inner">
            <div>
              ...
              <div className="mi-brand-sub">Curated market &amp; industry trends — no live API cost</div>
            </div>
        ...
        <div className="mi-body">
          <div className="mi-disclaimer">
            &#9888; These are curated, periodically-updated insights based on general market knowledge — not a live data feed.
